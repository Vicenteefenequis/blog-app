...
.learn-more .circle {
  ...
  width: 3rem;
  height: 3rem;
  background: -webkit-gradient(linear, left top, left bottom, color-stop(4%, #58f17b), color-stop(93%, #16cd6f)) no-repeat;
...
.learn-more .button-text {
  ...
  color: linear-gradient(-180deg, #58f17b 4%, #16cd6f 93%) no-repeat;
  font-weight: 700;
  line-height: 1.6;
  text-align: center;
