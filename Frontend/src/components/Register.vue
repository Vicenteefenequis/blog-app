<template>
    <div class="container">  
         <div  class="d-flex justify-content-center align-items-center flex-column mt-5 card p-3">
            ...
            <input class="mb-1 border shadow rounded p-2" v-model="email" placeholder="email" type="e-mail">
            <input class="mb-4 border shadow rounded p-2" v-model="senha" placeholder="senha" type="password">
